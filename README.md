...
```bash
curl https://raw.githubusercontent.com/grvweb/vesta/master/install/vst-install.sh | bash
```
...
```bash
curl -O https://raw.githubusercontent.com/grvweb/vesta/master/install/vst-install.sh
```
Then run it:
```bash
bash vst-install.sh
